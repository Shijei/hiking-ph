...
// Filters out the old auto-generated conquest body so legacy posts don't show it
...
export default function PostCard({ post, user, liked }: Props) {
  ...
  // For conquest posts, only show body if user actually typed a custom caption
  ...
  return (
    <div style={{ paddingTop: '14px', paddingBottom: '14px', borderBottom: '1px solid #f3f4f6' }}>
      ...
      {/* Body — conquest: only if user typed a custom caption; regular: always */}
      {showBody && (
      ...
      {/* Mountain tag pill — only for regular tagged posts */}
